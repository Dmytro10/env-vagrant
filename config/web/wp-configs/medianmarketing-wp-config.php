...
define('DB_NAME', 'MedianMarketing');
...
if(!empty($_SERVER['SERVER_NAME']) && $_SERVER['SERVER_NAME'] == 'devel.mediamarketing.com'){
...
$domains = array(
    array(
        'domain' => 'devel.medianmarketing.com',
        'siteurl' => 'http://devel.medianmarketing.com',
        'home' => 'http://devel.medianmarketing.com',
        'blogname' => 'devel.medianmarketing',
        'primary' => 'devel.medianmarketing.com',
        'robot_domain' => 'devel.medianmarketing.com'
    ),
    array(
