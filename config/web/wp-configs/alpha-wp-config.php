...
define('DB_NAME', 'AlphaPromotions');
...
if(!empty($_SERVER['SERVER_NAME']) && $_SERVER['SERVER_NAME'] == 'devel.alpha-promotions.co'){
...
$domains = array(
	array(
		'domain' => 'devel.alpha-promotions.co',
		'siteurl' => 'http://devel.alpha-promotions.co',
		'home' => 'http://devel.alpha-promotions.co',
		'blogname' => 'devel.alpha-promotions.co',
		'primary' => 'devel.alpha-promotions.co',
		'robot_domain' => 'www.devel.alpha-promotions.co'
	),
	array(
