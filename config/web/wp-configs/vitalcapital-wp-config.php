...
if(!empty($_SERVER['SERVER_NAME']) && $_SERVER['SERVER_NAME'] == 'devel.vitalcapital.co'){
...
$domains = array(
    array(
        'domain' => 'devel.vitalcapital.co',
        'siteurl' => 'http://devel.vitalcapital.co',
        'home' => 'http://devel.vitalcapital.co',
        'blogname' => 'vitalcapital',
        'primary' => 'devel.vitalcapital.co',
        'robot_domain' => 'devel.vitalcapital.co'
    ),
    array(
    ...
    array(
        ...
        'robot_domain' => 'www.vitalcapital.co'
    ),
...
$brands = array (
    ...
    'mscl' => array (
        ...
        'support_email' => 'support@vitalcapital.co',
